...
Visible repair verification kept the prior scene while the color function was broken, queued a click, and applied it exactly once after a one-form repair. The native suite has 64 passing tests, all five protocol scripts pass, and three Emacs integration tests pass.
